...
//   var docType = document.createElement('DOCTYPE'); // 'html';// <!DOCTYPE html>
//   docType.innerHTML = 'html';


//   var element1 = document.createElement('p');
//   element1.innerHTML = 'hello';

//   document.body.innerHTML = 'en'; //set html lang="en"

// })();

(function() {
  var titleTag = document.createElement('p');
  var titleText = titleTag.createTextNode = 'okgo';
